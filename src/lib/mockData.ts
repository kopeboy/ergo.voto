...
export const mockDebateData: Claim[] = [
		...
		children: [
			{
				...
				children: [
					...
					},
					{
						...
						user_created: 'ricercatore_clima',
						date_created: '2024-01-15T13:30:00Z',
						children: []
					}
				]
			},
			{
				...
				user_created: 'economista_pratico',
				...
				children: [
					{
						...
						user_created: 'green_economy',
						date_created: '2024-01-16T14:00:00Z',
						children: []
					}
				]
			}
	...
	},
	{
		...
		user_created: 'ingegnere_nucleare',
		...
		children: [
			{
				...
				user_created: 'ambientalista_verde',
